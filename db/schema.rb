...
ActiveRecord::Schema[7.0].define(version: 2023_04_05_104755) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "price_offer_items", force: :cascade do |t|
    t.string "name"
    ...
    t.index ["user_id"], name: "index_price_offer_items_on_user_id"
  end
